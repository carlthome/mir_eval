...
man_pages = [('index', 'mir_eval', 'mir_eval Documentation',
...
texinfo_documents = [
    ('index', 'mir_eval', 'mir_eval Documentation', 'Colin Raffel et al.',
     'mir_eval', 'One line description of project.', 'Miscellaneous'),
]
